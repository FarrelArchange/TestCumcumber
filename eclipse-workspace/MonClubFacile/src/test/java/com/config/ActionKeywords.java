...
import static com.executionEngine.DriverScriptTest.OR;
...
import com.executionEngine.DriverScriptTest;
...
public class ActionKeywords {
	...
	public ActionKeywords(){
		reports=new ExtentReports("C:\\Users\\rpoton\\eclipse-workspace\\MonClubFacile\\src\\test\\java\\com\\Report\\Report.html");
	}
	...
	//This block of code will decide which browser type to start
		...
		public static void navigate(String object, String data){
			try{
				Log.info("Navigating to URL1 "+ "'" + Constants.URL1+"'");
